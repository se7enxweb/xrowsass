<?php
//
// Definition of xrowsassPacker class
//
// Created on: <25-Mar-2013 12:00:00>
//
//

class xrowsasspacker
{
    /**
     * Constructor
     */
    ...
    {
        $ret = '';
        $packedFiles = xrowsasspacker::packFiles( $cssFiles, 'stylesheets/', '_' . $media . '.css', $packLevel, $indexDirInCacheHash );
    ...
    {
        return xrowsasspacker::packFiles( $cssFiles, 'stylesheets/', '_all.css', $packLevel, $indexDirInCacheHash );
    }
    ...
    static public function printDebugReport( $as_html = true )
    {
        ...
        if ( $as_html )
        {
            $stats .= '<h3>CSS/JS files loaded with "xrowsasspacker" during request:</h3>';
        ...
        {
            $stats .= "CSS/JS files loaded with 'xrowsasspacker' during request\n";
...
eZDebug::appendBottomReport( 'xrowsasspacker', array( 'xrowsasspacker', 'printDebugReport' ) );
